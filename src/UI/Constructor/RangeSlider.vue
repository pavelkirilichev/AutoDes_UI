...
<template>
    <div class="range-container" :class="props.expandOnHover ? 'expandOnHover' : ''" :style="{
    ...
    }" @mousemove="handlerangeUpdate" @mousedown="toggleScrubbing" @mouseup="isScrubbing = false"
        ...
        <div class="range">
            ...
            <slot></slot>
            <span v-if="!props.noThumb" class="thumb-indicator"
                :style="props.alwaysShowThumb ? { display: 'block' } : ''"></span>
        </div>
    </div>
</template>

<style lang="scss" scoped> .range-container {
